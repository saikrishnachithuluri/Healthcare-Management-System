...
@media (max-width:584px)
{
 ...
 <div class="container">
 <div class="heading">Doctor Registration Form </div>
         <form id="register" action="adddoctor" method="post" enctype="multipart/form-data">
         ...
         <div class="card-box">
             ...
             <div class="card-box">
             <label for="status" style="display:block;font-weight: 500;margin-bottom: 5px;">Status</label>
             <select name="status" id="status" style="height: 45px;width: 100%;outline: none;border-radius: 5px;border: 1px solid #ccc;padding-left: 15px;font-size: 16px;border-bottom-width: 2px;transition: all 0.3s ease;">
             ...
             <input type="text" name="contactno" required="required" placeholder="Enter your Contact Number" maxlength="10"></input>
             </div>
             <div class="card-box">
             ...
             <input type="file" name="docpic" required="required"/>
             </div>
