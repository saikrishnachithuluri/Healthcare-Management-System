...
<header>
    ...
    <nav class="navbar">
        <ul>
            ...
            <li><a href="viewdoctor" target="_blank">about</a></li>
            <li><a href="viewapp" target="_blank">View Appointments</a></li>
            <li><a href="docchangepwd" target="_blank">Update Password</a></li>
